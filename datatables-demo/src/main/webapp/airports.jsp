...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=contextPath%>/css/airports.css" />
    ...
    <script src="<%=contextPath%>/js/airports.js"></script>
</head>
<body>
<h1>Airports</h1>
<div id="container">
    <div class="col-lg-12">
        <table id="airports-tab" class="table table-condensed table-striped table-hover table-airports"></table>
    </div>
    <footer>
